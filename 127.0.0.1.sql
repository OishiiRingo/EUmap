...
--
-- Хост: 127.0.0.1
-- Время создания: Мар 10 2019 г., 22:41
...
-- База данных: `eumap`
--
CREATE DATABASE `eumap` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `eumap`;

-- --------------------------------------------------------

--
-- Структура таблицы `city_t`
--

CREATE TABLE IF NOT EXISTS `city_t` (
...
--
-- Структура таблицы `comment_capital_t`
--

CREATE TABLE IF NOT EXISTS `comment_capital_t` (
  `id_comment` int(11) NOT NULL AUTO_INCREMENT,
  `comment` text NOT NULL,
  `id_city` int(11) NOT NULL,
  `date` date NOT NULL,
  `like_col` int(11) NOT NULL DEFAULT '0',
  `id_user` int(11) NOT NULL,
  PRIMARY KEY (`id_comment`),
  UNIQUE KEY `id_city` (`id_city`,`id_user`),
  KEY `id_user` (`id_user`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
--
-- Структура таблицы `comment_country_t`
--

CREATE TABLE IF NOT EXISTS `comment_country_t` (
  `id_comment` int(11) NOT NULL AUTO_INCREMENT,
  `comment` text NOT NULL,
  `id_country` int(11) NOT NULL,
  `date` date NOT NULL,
  ...
  `id_user` int(11) NOT NULL,
  PRIMARY KEY (`id_comment`),
  UNIQUE KEY `id_country` (`id_country`,`id_user`),
  KEY `id_user` (`id_user`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
--
-- Структура таблицы `country_landuage_t`
--

CREATE TABLE IF NOT EXISTS `country_landuage_t` (
  `id_country_language` int(11) NOT NULL AUTO_INCREMENT,
  `id_country` int(11) NOT NULL,
  `id_language` int(11) NOT NULL,
  PRIMARY KEY (`id_country_language`),
  UNIQUE KEY `id_country` (`id_country`),
...
CREATE TABLE IF NOT EXISTS `country_t` (
  ...
  `gov_form` varchar(45) NOT NULL,
  `country_info` longtext NOT NULL,
  `position` varchar(25) NOT NULL,
  `part_of_eu` varchar(5) NOT NULL,
  `area` int(10) NOT NULL,
  `coastline` int(10) NOT NULL,
  `rating_europe` int(5) NOT NULL,
  `rating_world` int(5) NOT NULL,
  `population` int(10) NOT NULL,
  `density` float NOT NULL,
  `currency` varchar(5) NOT NULL,
  `gdp` float NOT NULL,
  `main_exp_res` varchar(45) NOT NULL,
  PRIMARY KEY (`id_country`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=45 ;

--
-- Дамп данных таблицы `country_t`
--

INSERT INTO `country_t` (`id_country`, `name`, `capital`, `gov_form`, `country_info`, `position`, `part_of_eu`, `area`, `coastline`, `rating_europe`, `rating_world`, `population`, `density`, `currency`, `gdp`, `main_exp_res`) VALUES
(1, 'Австрия', 'Вена', 'Федеративная парламентская республика', '1 austria', 'Западная Европа', 'Да', 83879, 0, 20, 113, 8711770, 102.1, 'EUR', 440, 'Техническое оборудование и транспорт'),
(2, 'Бельгия', 'Брюссель', 'Конституционная монархия', '2 belgium', 'Западная Европа', 'Да', 30528, 67, 33, 136, 11358952, 368.3, 'EUR', 528, 'Бриллианты'),
(3, 'Великобритания', 'Лондон', 'Парламентская монархия', '3 great britain', 'Северная Европа', 'Нет', 23809, 12429, 11, 78, 63395574, 246, 'GBP', 2914, 'Техническое оборудование и транспорт'),
(4, 'Германия', 'Берлин', 'Федеративная парламентская республика', '4 germany', 'Западная Европа', 'Да', 357021, 2389, 6, 62, 82521653, 227, 'EUR', 4199, 'Техническое оборудование и транспорт'),
(5, 'Ирландия', 'Дублин', 'Парламентская республика', '5 ireland', 'Северная Европа', 'Да', 70273, 1488, 22, 118, 4593100, 60.3, 'EUR', 357, 'Электроника'),
(6, 'Лихтенштейн', 'Лихтенштейн', 'Дуалистическая монархия', '6 liechtenstein', 'Западная Европа', 'Нет', 160, 0, 41, 189, 33307, 229.56, 'CHF', 3.5, 'Техническое оборудование и транспорт'),
(7, 'Люксембург', 'Люксембург', 'Конституционная монархия', '7 luxembourg', 'Западная Европа', 'Да', 2586, 0, 38, 167, 602005, 233, 'EUR', 62.7, 'Техническое оборудование и транспорт'),
(8, 'Монако', 'Монако', 'Конституционная монархия', '8 monako', 'Западная Европа', 'Нет', 2, 4, 43, 193, 37863, 18679, 'EUR', 6.1, 'Техническое оборудование и транспорт'),
(9, 'Нидерланды', 'Амстердам', 'Конституционная монархия', '9 netherlands', 'Западная Европа', 'Да', 41543, 451, 30, 131, 17208088, 405, 'EUR', 916, 'Техническое оборудование и транспорт'),
(10, 'Франция', 'Париж', 'Смешанная республика', '10 france', 'Западная Европа', 'Да', 674685, 4688, 3, 48, 64859773, 103, 'EUR', 2836, 'Техническое оборудование и транспорт'),
(11, 'Швейцария', 'Берн', 'Федеративная парламентская республика', '11 switzerland', 'Западная Европа', 'Нет', 41284, 0, 31, 132, 8560988, 207, 'CHF', 517, 'Техническое оборудование и транспорт'),
(12, 'Беларусь', 'Минск', 'Президентская республика', '12 belarus', 'Восточная Европа', 'Нет', 207600, 0, 13, 84, 9491823, 47.89, 'BR', 179, 'Техническое оборудование и транспорт'),
(13, 'Болгария', 'София', 'Парламентская республика', '13 bulgaria', 'Восточная Европа', 'Да', 110993, 354, 15, 103, 6999908, 63, 'BGN', 153, 'Текстиль'),
(14, 'Венгрия', 'Будапешт', 'Парламентская республика', '14 hungary', 'Восточная Европа', 'Да', 93036, 0, 17, 108, 9937628, 106, 'HUF', 289, 'Техническое оборудование и транспорт'),
(15, 'Молдавия', 'Кишинёв', 'Парламентская республика', '15 moldavia', 'Восточная Европа', 'Нет', 33846, 0, 32, 135, 3550900, 119.8, 'MDL', 20.1, 'Продовольствие'),
(16, 'Польша', 'Варшава', 'Парламентская республика', '16 poland', 'Восточная Европа', 'Да', 312679, 491, 9, 69, 38422346, 123, 'PLN', 1121, 'Техническое оборудование и транспорт'),
(17, 'Россия', 'Москва', 'Президентская республика', '17 russia', 'Восточная Европа', 'Нет', 17125191, 38808, 1, 1, 146880432, 8.56, 'RUB', 4016, 'Нефтепродукты'),
(18, 'Румыния', 'Бухарест', 'Президентско-парламентская республика', '18 romania', 'Восточная Европа', 'Да', 238391, 256, 12, 80, 19551000, 84.4, 'RON', 481, 'Металлы и минералы'),
(19, 'Словакия', 'Братислава', 'Парламентская республика', '19 slovakia', 'Восточная Европа', 'Да', 49034, 0, 27, 127, 5443120, 111, 'EUR', 179, 'Техническое оборудование и транспорт'),
(20, 'Чехия', 'Прага', 'Парламентская республика', '20 czech', 'Восточная Европа', 'Да', 78866, 0, 21, 115, 10538275, 133, 'CZK', 376, 'Техническое оборудование и транспорт'),
(21, 'Украина', 'Киев', 'Президентско-парламентская республика', '21 ukraine', 'Восточная Европа', 'Нет', 603549, 1355, 2, 44, 42248598, 73.92, 'UAH', 369, 'Нефтепродукты'),
(22, 'Дания', 'Копенгаген', 'Конституционная монархия', '22 denmark', 'Северная Европа', 'Да', 43094, 7314, 29, 130, 5693085, 126, 'DKK', 287, 'Техническое оборудование и транспорт'),
(23, 'Исландия', 'Рейкьявик', 'Парламентская республика', '23 iceland', 'Северная Европа', 'Нет', 103125, 4970, 16, 106, 321857, 3.1, 'ISK', 17.6, 'Продовольствие'),
(24, 'Латвия', 'Рига', 'Парламентская республика', '24 latvia', 'Северная Европа', 'Да', 64589, 498, 24, 122, 1934379, 29.95, 'EUR', 53.9, 'Продовольствие'),
(25, 'Литва', 'Вильнюс', 'Парламентская республика', '25 lithuania', 'Северная Европа', 'Да', 65301, 99, 23, 121, 2826534, 49, 'EUR', 91.2, 'Металлы и минералы'),
(26, 'Норвегия', 'Осло', 'Конституционная монархия', '26 norway', 'Северная Европа', 'Нет', 385186, 25148, 8, 67, 529619, 13.1, 'NOK', 380, 'Нефтепродукты'),
(27, 'Финляндия', 'Хельсинки', 'Парламентская республика', '27 finland', 'Северная Европа', 'Да', 338400, 1100, 7, 64, 5560000, 16, 'EUR', 244, 'Электроника'),
(28, 'Эстония', 'Таллин', 'Парламентская республика', '28 estonia', 'Северная Европа', 'Да', 45227, 3794, 28, 129, 1319133, 28, 'EUR', 41.6, 'Техническое оборудование и транспорт'),
(29, 'Швеция', 'Стокгольм', 'Конституционная монархия', '29 sweden', 'Северная Европа', 'Да', 447435, 3218, 5, 55, 10171524, 21.89, 'SEK', 521, 'Техническое оборудование и транспорт'),
(30, 'Албания', 'Тирана', 'Парламентская республика', '30 albania', 'Южная Европа', 'Нет', 28748, 362, 34, 139, 2876591, 100, 'ALB', 36, 'Текстиль'),
(31, 'Андорра', 'Андорра-ла-Велья', 'Парламентское княжество', '31 andorra', 'Западная Европа', 'Нет', 467, 0, 39, 178, 85470, 182.6, 'EUR', 4.5, 'Техническое оборудование и транспорт'),
(32, 'Босния и Герцеговина', 'Сараево', 'Республика', '32 bosnia and herzegovina', 'Южная Европа', 'Нет', 51197, 23, 26, 125, 3511372, 68.97, 'BAM', 44.6, 'Металлы и минералы'),
(33, 'Ватикан', 'Ватикан', 'Абсолютная теократическая монархия', '33 vatican', 'Южная Европа', 'Нет', 44, 0, 44, 273, 1000, 1913, 'EUR', 0, 'Нет'),
(34, 'Греция', 'Афины', 'Парламентская республика', '34 greece', 'Южная Европа', 'Да', 131957, 15021, 14, 95, 10749943, 81, 'EUR', 299, 'Продовольствие'),
(35, 'Испания', 'Мадрид', 'Конституционная монархия', '35 spain', 'Южная Европа', 'Да', 505990, 4964, 4, 51, 46468102, 92, 'EUR', 1774, 'Техническое оборудование и транспорт'),
(36, 'Италия', 'Рим', 'Парламентская республика', '36 Italy', 'Южная Европа', 'Да', 301340, 7600, 10, 71, 60795612, 201.1, 'EUR', 2311, 'Техническое оборудование и транспорт'),
(37, 'Македония', 'Скопье', 'Парламентская республика', '37 Macedonia', 'Южная Европа', 'Нет', 25333, 0, 35, 145, 2073702, 81, 'MKD', 31, 'Табак'),
(38, 'Мальта', 'Валлетта', 'Парламентская республика', '38 malta', 'Южная Европа', 'Да', 316, 137, 40, 185, 429344, 1432, 'EUR', 19.3, 'Техническое оборудование и транспорт'),
(39, 'Португалия', 'Лиссабон', 'Парламентская республика', '39 portugal', 'Южная Европа', 'Да', 92151, 1793, 18, 109, 10799270, 114, 'EUR', 313, 'Продовольствие'),
(40, 'Сан-Марино', 'Сан-Марино', 'Парламентская республика', '40 san-marino', 'Южная Европа', 'Нет', 61, 0, 42, 190, 33029, 539.69, 'EUR', 2.1, 'Техническое оборудование и транспорт'),
(41, 'Сербия', 'Белград', 'Парламентская республика', '41 serbia', 'Южная Европа', 'Нет', 88407, 0, 19, 111, 7041599, 80, 'RSD', 105, 'Металлы и минералы'),
(42, 'Словения', 'Любляна', 'Парламентская республика', '42 slovenia', 'Южная Европа', 'Да', 20273, 47, 36, 150, 2066880, 101.8, 'EUR', 71.1, 'Техническое оборудование и транспорт'),
(43, 'Хорватия', 'Загреб', 'Парламентская республика', '43 croatia', 'Южная Европа', 'Да', 56594, 1777, 25, 124, 4154213, 73.4, 'HRK', 101, 'Техническое оборудование и транспорт'),
(44, 'Черногория', 'Подгорица', 'Парламентская республика', '44 montenegro', 'Южная Европа', 'Нет', 13812, 294, 37, 155, 622218, 45, 'EUR', 11, 'Металлы и минералы');
...
CREATE TABLE IF NOT EXISTS `language_t` (
...
INSERT INTO `language_t` (`id_language`, `language`) VALUES
(1, 'Английский'),
(2, 'Немецкий'),
(3, 'Французский');
...
CREATE TABLE IF NOT EXISTS `user_t` (
  ...
  `email` varchar(45) NOT NULL COMMENT 'почта',
  ...
  `birth_date` date DEFAULT NULL COMMENT 'день рождение',
  PRIMARY KEY (`id_user`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
--
-- Ограничения внешнего ключа таблицы `city_t`
--
ALTER TABLE `city_t`
  ADD CONSTRAINT `city_t_ibfk_1` FOREIGN KEY (`id_country`) REFERENCES `country_t` (`id_country`);

--
-- Ограничения внешнего ключа таблицы `comment_capital_t`
--
ALTER TABLE `comment_capital_t`
  ADD CONSTRAINT `comment_capital_t_ibfk_1` FOREIGN KEY (`id_city`) REFERENCES `city_t` (`id_city`),
  ADD CONSTRAINT `comment_capital_t_ibfk_2` FOREIGN KEY (`id_user`) REFERENCES `user_t` (`id_user`);

--
-- Ограничения внешнего ключа таблицы `comment_country_t`
--
ALTER TABLE `comment_country_t`
  ADD CONSTRAINT `comment_country_t_ibfk_1` FOREIGN KEY (`id_country`) REFERENCES `country_t` (`id_country`),
  ADD CONSTRAINT `comment_country_t_ibfk_2` FOREIGN KEY (`id_user`) REFERENCES `user_t` (`id_user`);

--
-- Ограничения внешнего ключа таблицы `country_landuage_t`
--
ALTER TABLE `country_landuage_t`
  ADD CONSTRAINT `country_landuage_t_ibfk_1` FOREIGN KEY (`id_country`) REFERENCES `country_t` (`id_country`),
  ADD CONSTRAINT `country_landuage_t_ibfk_2` FOREIGN KEY (`id_language`) REFERENCES `language_t` (`id_language`);
--
...
('def', 'eumap', 'city_t', 'id_city', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'eumap', 'city_t', 'name', 2, NULL, 'NO', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'eumap', 'city_t', 'population', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'eumap', 'city_t', 'founding_date', 4, NULL, 'NO', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
('def', 'eumap', 'city_t', 'id_country', 5, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'UNI', '', 'select,insert,update,references', ''),
('def', 'eumap', 'city_t', 'city_info', 6, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'eumap', 'comment_capital_t', 'id_comment', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'eumap', 'comment_capital_t', 'comment', 2, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'eumap', 'comment_capital_t', 'id_city', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'eumap', 'comment_capital_t', 'date', 4, NULL, 'NO', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
('def', 'eumap', 'comment_capital_t', 'like_col', 5, '0', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'eumap', 'comment_capital_t', 'id_user', 6, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'eumap', 'comment_country_t', 'id_comment', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'eumap', 'comment_country_t', 'comment', 2, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'eumap', 'comment_country_t', 'id_country', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'eumap', 'comment_country_t', 'date', 4, NULL, 'NO', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
('def', 'eumap', 'comment_country_t', 'like_col', 5, '0', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'eumap', 'comment_country_t', 'id_user', 6, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'eumap', 'country_landuage_t', 'id_country_language', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'eumap', 'country_landuage_t', 'id_country', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'UNI', '', 'select,insert,update,references', ''),
('def', 'eumap', 'country_landuage_t', 'id_language', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'UNI', '', 'select,insert,update,references', ''),
('def', 'eumap', 'country_t', 'id_country', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'eumap', 'country_t', 'name', 2, NULL, 'NO', 'varchar', 30, 90, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'eumap', 'country_t', 'capital', 3, NULL, 'NO', 'varchar', 30, 90, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'eumap', 'country_t', 'gov_form', 4, NULL, 'NO', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'eumap', 'country_t', 'country_info', 5, NULL, 'NO', 'longtext', 4294967295, 4294967295, NULL, NULL, 'utf8', 'utf8_general_ci', 'longtext', '', '', 'select,insert,update,references', ''),
('def', 'eumap', 'country_t', 'position', 6, NULL, 'NO', 'varchar', 25, 75, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(25)', '', '', 'select,insert,update,references', ''),
('def', 'eumap', 'country_t', 'part_of_eu', 7, NULL, 'NO', 'varchar', 5, 15, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(5)', '', '', 'select,insert,update,references', ''),
('def', 'eumap', 'country_t', 'area', 8, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10)', '', '', 'select,insert,update,references', ''),
('def', 'eumap', 'country_t', 'coastline', 9, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10)', '', '', 'select,insert,update,references', ''),
('def', 'eumap', 'country_t', 'rating_europe', 10, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(5)', '', '', 'select,insert,update,references', ''),
('def', 'eumap', 'country_t', 'rating_world', 11, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(5)', '', '', 'select,insert,update,references', ''),
('def', 'eumap', 'country_t', 'population', 12, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10)', '', '', 'select,insert,update,references', ''),
('def', 'eumap', 'country_t', 'density', 13, NULL, 'NO', 'float', NULL, NULL, 12, NULL, NULL, NULL, 'float', '', '', 'select,insert,update,references', ''),
('def', 'eumap', 'country_t', 'currency', 14, NULL, 'NO', 'varchar', 5, 15, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(5)', '', '', 'select,insert,update,references', ''),
('def', 'eumap', 'country_t', 'gdp', 15, NULL, 'NO', 'float', NULL, NULL, 12, NULL, NULL, NULL, 'float', '', '', 'select,insert,update,references', ''),
('def', 'eumap', 'country_t', 'main_exp_res', 16, NULL, 'NO', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'eumap', 'language_t', 'id_language', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'eumap', 'language_t', 'language', 2, NULL, 'NO', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'eumap', 'user_t', 'id_user', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'eumap', 'user_t', 'login', 2, NULL, 'NO', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', 'логин'),
('def', 'eumap', 'user_t', 'password', 3, NULL, 'NO', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', 'пароль'),
('def', 'eumap', 'user_t', 'email', 4, NULL, 'NO', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', 'почта'),
('def', 'eumap', 'user_t', 'first_name', 5, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', 'имя'),
('def', 'eumap', 'user_t', 'second_name', 6, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', 'фамилия'),
('def', 'eumap', 'user_t', 'country', 7, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', 'страна'),
('def', 'eumap', 'user_t', 'gender', 8, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', 'пол'),
('def', 'eumap', 'user_t', 'birth_date', 9, NULL, 'YES', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', 'день рождение'),
...
('COM_SHOW_TABLE_STATUS', '249'),
('COM_SHOW_TABLES', '113'),
('COM_SHOW_TRIGGERS', '15'),
('COM_SHOW_VARIABLES', '66'),
...
('COMPRESSION', 'OFF'),
('CONNECTIONS', '607'),
('CREATED_TMP_DISK_TABLES', '453'),
('CREATED_TMP_FILES', '5'),
('CREATED_TMP_TABLES', '1746'),
('DELAYED_ERRORS', '0'),
...
('HANDLER_DISCOVER', '0'),
('HANDLER_PREPARE', '0'),
('HANDLER_READ_FIRST', '763'),
('HANDLER_READ_KEY', '271'),
('HANDLER_READ_LAST', '0'),
('HANDLER_READ_NEXT', '1013'),
('HANDLER_READ_PREV', '0'),
('HANDLER_READ_RND', '17'),
('HANDLER_READ_RND_NEXT', '23696'),
('HANDLER_ROLLBACK', '0'),
('HANDLER_SAVEPOINT', '0'),
...
('INNODB_BUFFER_POOL_PAGES_FLUSHED', '943'),
...
('INNODB_BUFFER_POOL_READ_REQUESTS', '17170'),
('INNODB_BUFFER_POOL_READS', '0'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '7073'),
('INNODB_DATA_FSYNCS', '358'),
...
('INNODB_DATA_WRITTEN', '30029824'),
('INNODB_DBLWR_PAGES_WRITTEN', '770'),
('INNODB_DBLWR_WRITES', '68'),
('INNODB_HAVE_ATOMIC_BUILTINS', 'ON'),
('INNODB_LOG_WAITS', '0'),
('INNODB_LOG_WRITE_REQUESTS', '3777'),
('INNODB_LOG_WRITES', '148'),
('INNODB_OS_LOG_FSYNCS', '206'),
('INNODB_OS_LOG_PENDING_FSYNCS', '0'),
('INNODB_OS_LOG_PENDING_WRITES', '0'),
('INNODB_OS_LOG_WRITTEN', '1933824'),
('INNODB_PAGE_SIZE', '16384'),
('INNODB_PAGES_CREATED', '446'),
('INNODB_PAGES_READ', '0'),
('INNODB_PAGES_WRITTEN', '943'),
...
('INNODB_ROWS_INSERTED', '51'),
('INNODB_ROWS_READ', '1353'),
...
('THREADS_RUNNING', '1'),
('UPTIME', '11743'),
('UPTIME_SINCE_FLUSH_STATUS', '11743');
...
('PID_FILE', 'Z:\\usr\\local\\mysql-5.5\\data\\DESKTOP-GS3D43U.pid'),
('KEY_CACHE_DIVISION_LIMIT', '100'),
('COLLATION_SERVER', 'utf8_general_ci'),
('GENERAL_LOG_FILE', 'Z:\\usr\\local\\mysql-5.5\\data\\DESKTOP-GS3D43U.log'),
('FLUSH_TIME', '1800'),
...
('LOG_ERROR', 'Z:\\usr\\local\\mysql-5.5\\data\\DESKTOP-GS3D43U.err'),
...
('SLOW_QUERY_LOG_FILE', 'Z:\\usr\\local\\mysql-5.5\\data\\DESKTOP-GS3D43U-slow.log'),
...
('def', 'eumap', 'PRIMARY', 'def', 'eumap', 'city_t', 'id_city', 1, NULL, NULL, NULL, NULL),
('def', 'eumap', 'id_country', 'def', 'eumap', 'city_t', 'id_country', 1, NULL, NULL, NULL, NULL),
('def', 'eumap', 'city_t_ibfk_1', 'def', 'eumap', 'city_t', 'id_country', 1, 1, 'eumap', 'country_t', 'id_country'),
('def', 'eumap', 'PRIMARY', 'def', 'eumap', 'comment_capital_t', 'id_comment', 1, NULL, NULL, NULL, NULL),
('def', 'eumap', 'id_city', 'def', 'eumap', 'comment_capital_t', 'id_city', 1, NULL, NULL, NULL, NULL),
('def', 'eumap', 'id_city', 'def', 'eumap', 'comment_capital_t', 'id_user', 2, NULL, NULL, NULL, NULL),
('def', 'eumap', 'comment_capital_t_ibfk_1', 'def', 'eumap', 'comment_capital_t', 'id_city', 1, 1, 'eumap', 'city_t', 'id_city'),
('def', 'eumap', 'comment_capital_t_ibfk_2', 'def', 'eumap', 'comment_capital_t', 'id_user', 1, 1, 'eumap', 'user_t', 'id_user'),
('def', 'eumap', 'PRIMARY', 'def', 'eumap', 'comment_country_t', 'id_comment', 1, NULL, NULL, NULL, NULL),
('def', 'eumap', 'id_country', 'def', 'eumap', 'comment_country_t', 'id_country', 1, NULL, NULL, NULL, NULL),
('def', 'eumap', 'id_country', 'def', 'eumap', 'comment_country_t', 'id_user', 2, NULL, NULL, NULL, NULL),
('def', 'eumap', 'comment_country_t_ibfk_1', 'def', 'eumap', 'comment_country_t', 'id_country', 1, 1, 'eumap', 'country_t', 'id_country'),
('def', 'eumap', 'comment_country_t_ibfk_2', 'def', 'eumap', 'comment_country_t', 'id_user', 1, 1, 'eumap', 'user_t', 'id_user'),
('def', 'eumap', 'PRIMARY', 'def', 'eumap', 'country_landuage_t', 'id_country_language', 1, NULL, NULL, NULL, NULL),
('def', 'eumap', 'id_country', 'def', 'eumap', 'country_landuage_t', 'id_country', 1, NULL, NULL, NULL, NULL),
('def', 'eumap', 'id_language', 'def', 'eumap', 'country_landuage_t', 'id_language', 1, NULL, NULL, NULL, NULL),
('def', 'eumap', 'country_landuage_t_ibfk_1', 'def', 'eumap', 'country_landuage_t', 'id_country', 1, 1, 'eumap', 'country_t', 'id_country'),
('def', 'eumap', 'country_landuage_t_ibfk_2', 'def', 'eumap', 'country_landuage_t', 'id_language', 1, 1, 'eumap', 'language_t', 'id_language'),
('def', 'eumap', 'PRIMARY', 'def', 'eumap', 'country_t', 'id_country', 1, NULL, NULL, NULL, NULL),
('def', 'eumap', 'PRIMARY', 'def', 'eumap', 'language_t', 'id_language', 1, NULL, NULL, NULL, NULL),
('def', 'eumap', 'PRIMARY', 'def', 'eumap', 'user_t', 'id_user', 1, NULL, NULL, NULL, NULL),
...
('def', 'information_schema', 'CHARACTER_SETS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 384, 0, 16604160, 0, 0, '2019-03-10 18:41:36', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 231, 0, 16704765, 0, 0, '2019-03-10 18:41:36', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 195, 0, 16691610, 0, 0, '2019-03-10 18:41:36', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMNS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2019-03-10 18:41:36', '2019-03-10 18:41:36', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMN_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2565, 0, 16757145, 0, 0, '2019-03-10 18:41:36', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ENGINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 490, 0, 16709000, 0, 0, '2019-03-10 18:41:36', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'EVENTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2019-03-10 18:41:36', '2019-03-10 18:41:36', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'FILES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2677, 0, 16758020, 0, 0, '2019-03-10 18:41:36', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2019-03-10 18:41:36', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2019-03-10 18:41:36', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'KEY_COLUMN_USAGE', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4637, 0, 16762755, 0, 0, '2019-03-10 18:41:36', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARAMETERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2019-03-10 18:41:36', '2019-03-10 18:41:36', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARTITIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2019-03-10 18:41:36', '2019-03-10 18:41:36', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PLUGINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2019-03-10 18:41:36', '2019-03-10 18:41:36', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROCESSLIST', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2019-03-10 18:41:36', '2019-03-10 18:41:36', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROFILING', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 308, 0, 16562084, 0, 0, '2019-03-10 18:41:36', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4814, 0, 16767162, 0, 0, '2019-03-10 18:41:36', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ROUTINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2019-03-10 18:41:36', '2019-03-10 18:41:36', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMATA', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3464, 0, 16755368, 0, 0, '2019-03-10 18:41:36', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2179, 0, 16767405, 0, 0, '2019-03-10 18:41:36', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2019-03-10 18:41:36', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2019-03-10 18:41:36', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'STATISTICS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 5753, 0, 16764242, 0, 0, '2019-03-10 18:41:36', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9450, 0, 16764300, 0, 0, '2019-03-10 18:41:36', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLESPACES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 6951, 0, 16772763, 0, 0, '2019-03-10 18:41:36', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2504, 0, 16749256, 0, 0, '2019-03-10 18:41:36', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2372, 0, 16748692, 0, 0, '2019-03-10 18:41:36', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TRIGGERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2019-03-10 18:41:36', '2019-03-10 18:41:36', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'USER_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 1986, 0, 16759854, 0, 0, '2019-03-10 18:41:36', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'VIEWS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2019-03-10 18:41:36', '2019-03-10 18:41:36', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 14979650, 0, 0, '2019-03-10 18:41:36', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_TRX', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4534, 0, 16766732, 0, 0, '2019-03-10 18:41:36', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2019-03-10 18:41:36', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCK_WAITS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 599, 0, 16749238, 0, 0, '2019-03-10 18:41:36', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2019-03-10 18:41:36', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 14979650, 0, 0, '2019-03-10 18:41:36', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCKS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 31244, 0, 16746784, 0, 0, '2019-03-10 18:41:36', NULL, NULL, NULL, '', '', NULL),
('def', 'eumap', 'city_t', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 16384, 0, '2019-03-10 15:35:32', NULL, NULL, NULL, '', '', NULL),
('def', 'eumap', 'comment_capital_t', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 32768, 0, '2019-03-10 15:35:32', NULL, NULL, NULL, '', '', NULL),
('def', 'eumap', 'comment_country_t', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 32768, 0, '2019-03-10 15:35:32', NULL, NULL, NULL, '', '', NULL),
('def', 'eumap', 'country_landuage_t', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 32768, 0, '2019-03-10 15:35:32', NULL, NULL, NULL, '', '', NULL),
('def', 'eumap', 'country_t', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 44, 372, 16384, NULL, 0, 0, '2019-03-10 15:35:32', NULL, NULL, NULL, '', '', NULL),
('def', 'eumap', 'language_t', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 5461, 16384, NULL, 0, 0, '2019-03-10 15:35:32', NULL, NULL, NULL, '', '', NULL),
('def', 'eumap', 'user_t', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 0, '2019-03-10 15:35:33', NULL, NULL, NULL, '', '', NULL),
...
('def', 'phpmyadmin', 'pma_recent', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 280, 280, 281474976710655, 2048, 0, '2012-06-11 22:55:25', '2019-03-10 15:51:05', NULL, NULL, '', '', NULL),
...
('def', 'phpmyadmin', 'pma_userconfig', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 28, 28, 281474976710655, 2048, 0, '2012-06-11 22:55:25', '2019-03-10 15:35:33', NULL, NULL, '', '', NULL);
...
(606, 'root', 'localhost:51227', 'eumap', 'Query', 0, 'executing', 'SELECT * FROM `information_schema`.`PROCESSLIST`'),
(605, 'root', 'localhost:51226', NULL, 'Sleep', 1, '', NULL);
...
('def', 'eumap', 'city_t_ibfk_1', 'def', 'eumap', 'PRIMARY', 'NONE', 'RESTRICT', 'RESTRICT', 'city_t', 'country_t'),
('def', 'eumap', 'comment_capital_t_ibfk_1', 'def', 'eumap', 'PRIMARY', 'NONE', 'RESTRICT', 'RESTRICT', 'comment_capital_t', 'city_t'),
('def', 'eumap', 'comment_capital_t_ibfk_2', 'def', 'eumap', 'PRIMARY', 'NONE', 'RESTRICT', 'RESTRICT', 'comment_capital_t', 'user_t'),
('def', 'eumap', 'comment_country_t_ibfk_1', 'def', 'eumap', 'PRIMARY', 'NONE', 'RESTRICT', 'RESTRICT', 'comment_country_t', 'country_t'),
('def', 'eumap', 'comment_country_t_ibfk_2', 'def', 'eumap', 'PRIMARY', 'NONE', 'RESTRICT', 'RESTRICT', 'comment_country_t', 'user_t'),
('def', 'eumap', 'country_landuage_t_ibfk_1', 'def', 'eumap', 'PRIMARY', 'NONE', 'RESTRICT', 'RESTRICT', 'country_landuage_t', 'country_t'),
('def', 'eumap', 'country_landuage_t_ibfk_2', 'def', 'eumap', 'PRIMARY', 'NONE', 'RESTRICT', 'RESTRICT', 'country_landuage_t', 'language_t');
...
('def', 'eumap', 'utf8', 'utf8_general_ci', NULL),
...
('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '17464'),
('INNODB_BUFFER_POOL_READS', '0'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '7073'),
('INNODB_DATA_FSYNCS', '358'),
...
('THREADS_RUNNING', '1'),
('UPTIME', '11744'),
('UPTIME_SINCE_FLUSH_STATUS', '11744');
...
('def', 'eumap', 'city_t', 0, 'eumap', 'PRIMARY', 1, 'id_city', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'eumap', 'city_t', 0, 'eumap', 'id_country', 1, 'id_country', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'eumap', 'comment_capital_t', 0, 'eumap', 'PRIMARY', 1, 'id_comment', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'eumap', 'comment_capital_t', 0, 'eumap', 'id_city', 1, 'id_city', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'eumap', 'comment_capital_t', 0, 'eumap', 'id_city', 2, 'id_user', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'eumap', 'comment_capital_t', 1, 'eumap', 'id_user', 1, 'id_user', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'eumap', 'comment_country_t', 0, 'eumap', 'PRIMARY', 1, 'id_comment', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'eumap', 'comment_country_t', 0, 'eumap', 'id_country', 1, 'id_country', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'eumap', 'comment_country_t', 0, 'eumap', 'id_country', 2, 'id_user', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'eumap', 'comment_country_t', 1, 'eumap', 'id_user', 1, 'id_user', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'eumap', 'country_landuage_t', 0, 'eumap', 'PRIMARY', 1, 'id_country_language', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'eumap', 'country_landuage_t', 0, 'eumap', 'id_country', 1, 'id_country', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'eumap', 'country_landuage_t', 0, 'eumap', 'id_language', 1, 'id_language', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'eumap', 'country_t', 0, 'eumap', 'PRIMARY', 1, 'id_country', 'A', 44, NULL, NULL, '', 'BTREE', '', ''),
('def', 'eumap', 'language_t', 0, 'eumap', 'PRIMARY', 1, 'id_language', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', 'eumap', 'user_t', 0, 'eumap', 'PRIMARY', 1, 'id_user', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
...
('def', 'information_schema', 'CHARACTER_SETS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 384, 0, 16604160, 0, 0, NULL, '2019-03-10 18:41:36', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=43690', ''),
('def', 'information_schema', 'COLLATIONS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 231, 0, 16704765, 0, 0, NULL, '2019-03-10 18:41:36', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=72628', ''),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 195, 0, 16691610, 0, 0, NULL, '2019-03-10 18:41:36', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=86037', ''),
('def', 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2019-03-10 18:41:36', '2019-03-10 18:41:36', NULL, 'utf8_general_ci', NULL, 'max_rows=2802', ''),
('def', 'information_schema', 'COLUMN_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2565, 0, 16757145, 0, 0, NULL, '2019-03-10 18:41:36', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6540', ''),
('def', 'information_schema', 'ENGINES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 490, 0, 16709000, 0, 0, NULL, '2019-03-10 18:41:36', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=34239', ''),
('def', 'information_schema', 'EVENTS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2019-03-10 18:41:36', '2019-03-10 18:41:36', NULL, 'utf8_general_ci', NULL, 'max_rows=618', ''),
('def', 'information_schema', 'FILES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2677, 0, 16758020, 0, 0, NULL, '2019-03-10 18:41:36', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6267', ''),
('def', 'information_schema', 'GLOBAL_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2019-03-10 18:41:36', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'GLOBAL_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2019-03-10 18:41:36', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'KEY_COLUMN_USAGE', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4637, 0, 16762755, 0, 0, NULL, '2019-03-10 18:41:36', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3618', ''),
('def', 'information_schema', 'PARAMETERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2019-03-10 18:41:36', '2019-03-10 18:41:36', NULL, 'utf8_general_ci', NULL, 'max_rows=6050', ''),
('def', 'information_schema', 'PARTITIONS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2019-03-10 18:41:36', '2019-03-10 18:41:36', NULL, 'utf8_general_ci', NULL, 'max_rows=5579', ''),
('def', 'information_schema', 'PLUGINS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2019-03-10 18:41:36', '2019-03-10 18:41:36', NULL, 'utf8_general_ci', NULL, 'max_rows=11328', ''),
('def', 'information_schema', 'PROCESSLIST', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2019-03-10 18:41:36', '2019-03-10 18:41:36', NULL, 'utf8_general_ci', NULL, 'max_rows=23899', ''),
('def', 'information_schema', 'PROFILING', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 308, 0, 16562084, 0, 0, NULL, '2019-03-10 18:41:36', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=54471', ''),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4814, 0, 16767162, 0, 0, NULL, '2019-03-10 18:41:36', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3485', ''),
('def', 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2019-03-10 18:41:36', '2019-03-10 18:41:36', NULL, 'utf8_general_ci', NULL, 'max_rows=583', ''),
('def', 'information_schema', 'SCHEMATA', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3464, 0, 16755368, 0, 0, NULL, '2019-03-10 18:41:36', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=4843', ''),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2179, 0, 16767405, 0, 0, NULL, '2019-03-10 18:41:36', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7699', ''),
('def', 'information_schema', 'SESSION_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2019-03-10 18:41:36', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'SESSION_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2019-03-10 18:41:36', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'STATISTICS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 5753, 0, 16764242, 0, 0, NULL, '2019-03-10 18:41:36', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2916', ''),
('def', 'information_schema', 'TABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 9450, 0, 16764300, 0, 0, NULL, '2019-03-10 18:41:36', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=1775', ''),
('def', 'information_schema', 'TABLESPACES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 6951, 0, 16772763, 0, 0, NULL, '2019-03-10 18:41:36', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2413', ''),
('def', 'information_schema', 'TABLE_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2504, 0, 16749256, 0, 0, NULL, '2019-03-10 18:41:36', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6700', ''),
('def', 'information_schema', 'TABLE_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2372, 0, 16748692, 0, 0, NULL, '2019-03-10 18:41:36', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7073', ''),
('def', 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2019-03-10 18:41:36', '2019-03-10 18:41:36', NULL, 'utf8_general_ci', NULL, 'max_rows=569', ''),
('def', 'information_schema', 'USER_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 1986, 0, 16759854, 0, 0, NULL, '2019-03-10 18:41:36', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=8447', ''),
('def', 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2019-03-10 18:41:36', '2019-03-10 18:41:36', NULL, 'utf8_general_ci', NULL, 'max_rows=6935', ''),
('def', 'information_schema', 'INNODB_CMP_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 14979650, 0, 0, NULL, '2019-03-10 18:41:36', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_TRX', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4534, 0, 16766732, 0, 0, NULL, '2019-03-10 18:41:36', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3700', ''),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2019-03-10 18:41:36', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_LOCK_WAITS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 599, 0, 16749238, 0, 0, NULL, '2019-03-10 18:41:36', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=28008', ''),
('def', 'information_schema', 'INNODB_CMPMEM', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2019-03-10 18:41:36', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_CMP', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 14979650, 0, 0, NULL, '2019-03-10 18:41:36', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_LOCKS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 31244, 0, 16746784, 0, 0, NULL, '2019-03-10 18:41:36', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=536', ''),
('def', 'eumap', 'city_t', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 16384, 8388608, 1, '2019-03-10 15:35:32', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'eumap', 'comment_capital_t', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 32768, 8388608, 1, '2019-03-10 15:35:32', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'eumap', 'comment_country_t', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 32768, 8388608, 1, '2019-03-10 15:35:32', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'eumap', 'country_landuage_t', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 32768, 8388608, 1, '2019-03-10 15:35:32', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'eumap', 'country_t', 'BASE TABLE', 'InnoDB', 10, 'Compact', 44, 372, 16384, 0, 0, 8388608, 45, '2019-03-10 15:35:32', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'eumap', 'language_t', 'BASE TABLE', 'InnoDB', 10, 'Compact', 3, 5461, 16384, 0, 0, 8388608, 4, '2019-03-10 15:35:32', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'eumap', 'user_t', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 8388608, 1, '2019-03-10 15:35:33', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
...
('def', 'phpmyadmin', 'pma_recent', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 1, 280, 280, 281474976710655, 2048, 0, NULL, '2012-06-11 22:55:25', '2019-03-10 15:51:05', NULL, 'utf8_bin', NULL, '', 'Recently accessed tables'),
...
('def', 'phpmyadmin', 'pma_userconfig', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 1, 28, 28, 281474976710655, 2048, 0, NULL, '2012-06-11 22:55:25', '2019-03-10 15:35:33', NULL, 'utf8_bin', NULL, '', 'User preferences storage for phpMyAdmin');
...
('def', 'eumap', 'PRIMARY', 'eumap', 'city_t', 'PRIMARY KEY'),
('def', 'eumap', 'id_country', 'eumap', 'city_t', 'UNIQUE'),
('def', 'eumap', 'city_t_ibfk_1', 'eumap', 'city_t', 'FOREIGN KEY'),
('def', 'eumap', 'PRIMARY', 'eumap', 'comment_capital_t', 'PRIMARY KEY'),
('def', 'eumap', 'id_city', 'eumap', 'comment_capital_t', 'UNIQUE'),
('def', 'eumap', 'comment_capital_t_ibfk_1', 'eumap', 'comment_capital_t', 'FOREIGN KEY'),
('def', 'eumap', 'comment_capital_t_ibfk_2', 'eumap', 'comment_capital_t', 'FOREIGN KEY'),
('def', 'eumap', 'PRIMARY', 'eumap', 'comment_country_t', 'PRIMARY KEY'),
('def', 'eumap', 'id_country', 'eumap', 'comment_country_t', 'UNIQUE'),
('def', 'eumap', 'comment_country_t_ibfk_1', 'eumap', 'comment_country_t', 'FOREIGN KEY'),
('def', 'eumap', 'comment_country_t_ibfk_2', 'eumap', 'comment_country_t', 'FOREIGN KEY'),
('def', 'eumap', 'PRIMARY', 'eumap', 'country_landuage_t', 'PRIMARY KEY'),
('def', 'eumap', 'id_country', 'eumap', 'country_landuage_t', 'UNIQUE'),
('def', 'eumap', 'id_language', 'eumap', 'country_landuage_t', 'UNIQUE'),
('def', 'eumap', 'country_landuage_t_ibfk_1', 'eumap', 'country_landuage_t', 'FOREIGN KEY'),
('def', 'eumap', 'country_landuage_t_ibfk_2', 'eumap', 'country_landuage_t', 'FOREIGN KEY'),
('def', 'eumap', 'PRIMARY', 'eumap', 'country_t', 'PRIMARY KEY'),
('def', 'eumap', 'PRIMARY', 'eumap', 'language_t', 'PRIMARY KEY'),
('def', 'eumap', 'PRIMARY', 'eumap', 'user_t', 'PRIMARY KEY'),
...
('root', '[{"db":"eumap","table":"country_t"},{"db":"eumap","table":"city_t"},{"db":"eumap","table":"user_t"},{"db":"eumap","table":"language_t"},{"db":"eumap","table":"country_landuage_t"},{"db":"eumap","table":"comment_country_t"},{"db":"eumap","table":"comment_capital_t"}]');
...
('root', '2019-03-10 15:31:56', '{"lang":"ru"}');
